...
<!-- GENERADO por context.mjs · NO editar a mano · 2026-06-15T11:02:54.243Z -->
...
- **Ultimo commit:** e14d6e7 feat(kangeiko): makeCdpWebRunner real para WEB ABIERTA (read-only, guard ⚑)
- **Tamano:** 389 ficheros de codigo (49156 LOC), 135 de test
...
| `src/shitsuji/` | 7 | _(anade un banner de cabecera)_ |
