...
mkdirSync(path.join(REPO_ROOT, 'artifacts', 'eje_b_validation'), { recursive: true });
...
async function main() {
  ...
  writeFileSync(path.join(REPO_ROOT, 'artifacts', 'eje_b_validation', 't1_output.json'), JSON.stringify(result, null, 2));
